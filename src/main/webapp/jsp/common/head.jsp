		...
		<div class="left">
			...
			<nav>
				<ul class="list">
					...
					<li><a href="${pageContext.request.contextPath }/info.do">用户管理</a></li>
					<li><a href="${pageContext.request.contextPath }/roleInfo.do">角色管理</a></li>
					<li><a href="${pageContext.request.contextPath }/goUpdatePassword.do">密码修改</a></li>
