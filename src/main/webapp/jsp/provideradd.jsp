...
<div class="right">
	...
	<div class="providerAdd">
		<form id="providerForm" name="providerForm"
			...
			action="${pageContext.request.contextPath }/provideradd.do">
			...
			<div>
				<label for="totalPrice">企业营业技术执照：</label> <input type="file"
					 name="photos" id="photos" value=""> <font color="red">${error }</font>
			</div>
			<div>
				<label for="totalPrice">组织机构代码证：</label> <input type="file"
					 name="photos" id="photos" value="">
					<font color="red">${error }</font>
			</div>
			<div class="providerAddBtn">
				<input type="button" name="add" id="add" value="保存"> <input
					type="button" id="back" name="back" value="返回"> <font
					color="red"></font>
			</div>
		</form>
	</div>
