 ...
 <div class="right">
        ...
        <div class="providerView">
            ...
            <p><strong>描述：</strong><span>${provider.proDesc}</span></p>
             <p><strong>企业营业技术执照：</strong><img src="${pageContext.request.contextPath }/${provider.zhiZhao}"/></p>
              <p><strong>组织机构代码证：</strong><img src="${pageContext.request.contextPath }/${provider.daiMa}"/></p>
